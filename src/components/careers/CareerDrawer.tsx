...
import { HiCheck as CheckIcon, HiRefresh as RepeatIcon } from 'react-icons/hi';
import {
  convertNameToUrl,
  getFromLocalStorage,
  queryPathElementsById,
} from './RenderFunctions';
import CareerDrawerContent from '@/components/careers/CareerDrawerContent';
import { IconButton } from 'src/components/Drawer';
