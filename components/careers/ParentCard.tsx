...
function ParentCard(item) {
  ...
  return (
    <div className='relative'>
      <div
        className={` flex items-center text-lg font-semibold  leading-9 tracking-tight text-gray-800 dark:text-gray-100 sm:text-xl sm:leading-10 md:text-2xl md:leading-12`}
      >
        {item.path === '' && item.name}
